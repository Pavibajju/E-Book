...
const EditBooking = () => {
   ...
   const onSubmit = e => {
      ...
      axios({
          ...
          data: formData,
          config: { headers: {'Content-Type': 'multipart/form-data' ,'Accept': 'application/json','Content-Type': 'application/json'},
   ...
   const loadUser = async () => {
      var id = localStorage.getItem('id');      
      axios.get('http://localhost:8080/book/'+id).then(result => {         
         setUser(result.data);
